...
public interface Constants {
  ...
  // Thermal
    ...
    // Backlight Dimmer
    String BACKLIGHT_DIMMER = "/sys/module/mdss_fb/parameters/backlight_dimmer";
    String LM3630_BACKLIGHT_DIMMER = "null";
    ...
    String MSM_BACKLIGHT_DIMMER = "null";

    String[] MIN_BRIGHTNESS_ARRAY = {LM3630_MIN_BRIGHTNESS};
    ...
    String[][] SCREEN_ARRAY = {SCREEN_RGB_ARRAY, SCREEN_RGB_CTRL_ARRAY, SCREEN_KCAL_CTRL_NEW_ARRAY, K_GAMMA_ARRAY,
            ...
            {SCREEN_KCAL_CTRL_MIN, SCREEN_HBM, LM3530_BRIGTHNESS_MODE, LM3530_MIN_BRIGHTNESS, LM3530_MAX_BRIGHTNESS,
                    ...
                    NEGATIVE_TOGGLE, REGISTER_HOOK, MASTER_SEQUENCE, GLOVE_MODE, BACKLIGHT_DIMMER}};
    ...
    String[][] WAKE_ARRAY = {DT2W_ARRAY, S2W_ARRY, T2W_ARRAY, WAKE_MISC_ARRAY, SLEEP_MISC_ARRAY, WAKE_TIMEOUT_ARRAY,
            POCKET_MODE_ARRAY, {LENIENT, GESTURE_CRTL, CAMERA_GESTURE, POWER_KEY_SUSPEND, TW, MW}};
    ...
    String HEADPHONE_GAIN_L = "/sys/kernel/sound_control_3/gpl_headphone_l_gain";
    String HEADPHONE_GAIN_R = "/sys/kernel/sound_control_3/gpl_headphone_r_gain";
    ...
    String[][] SOUND_ARRAY = {SPEAKER_GAIN_ARRAY, {SOUND_CONTROL_ENABLE, HIGHPERF_MODE_ENABLE, HEADPHONE_GAIN_L, HEADPHONE_GAIN_R, HANDSET_MICROPONE_GAIN,
    ...
    Object[][] MISC_ARRAY = {
            ...
            SMB135X_WAKELOCKS, WLAN_RX_WAKELOCKS, WLAN_CTRL_WAKELOCKS, WLAN_WAKELOCKS, CRC_ARRAY, FSYNC_ARRAY, {SWITCH_BUTTONS}};
